...
const QuranData = (function () {
  ...
  // اندیس تجمعی آیه در کل قرآن (برای محاسبهٔ درصد پیشرفت خواندن)
  // مثال: سورهٔ ۲ آیهٔ ۱ → ۷ (بعد از ۷ آیهٔ سورهٔ فاتحه) + ۱ = ۸
  async function cumulativeIndex(surahNumber, ayahNumber) {
  ...
  return { getIndex, getSurah, getAyah, cumulativeIndex, TOTAL_AYAHS };
})();
