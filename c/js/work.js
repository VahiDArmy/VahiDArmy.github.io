(async function () {
  ...
  let currentAyahTafsirs = []; // همهٔ تفاسیر همان آیه (می‌تواند چند تا باشد)
  ...
  async function loadLatest() {
    ...
    currentAyahTafsirs = await Store.getTafsirsForAyah(surah, ayah);
    renderTafsirCards(currentAyahTafsirs, surahData);
  }

  function renderTafsirCards(tafsirs, surahData) {
